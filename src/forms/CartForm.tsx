  ...
  return (<>
        <form className="">        
            ...
            <div className="flex mb-10 max-w-[300px]">
                ...
                <button type="submit" className="flex-1 block bg-primary hover:bg-gray-darker text-center py-4 px-7.5 text-sm rounded-[5px] text-white tracking-[1px] font-bold uppercase w-full transition-colors duration-500 ease-in-out disabled:bg-red disabled:cursor-not-allowed">Add to cart</button>
