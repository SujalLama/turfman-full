            ...
            <div className="flex items-center justify-center flex-col">
                <div className="bg-white p-5 md:p-10 rounded-[5px] shadow max-w-[450px]">
                    <div className="mb-12 text-center">
                        <h2 className="leading-[1.1] text-primary text-[28px] font-bold mb-2.5">Login form</h2>
                        <p className="leading-snug text-sm">Please fill up the form. If you want to sign in.</p>
                    </div>
                    <LoginForm />
